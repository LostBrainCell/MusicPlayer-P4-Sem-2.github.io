class MusicPlayer {
  ...
  void divsArray() {
    ...
    divs[4] = divs[0] / 15 ; //Even for Width 25% of displayWidth
    divs[5] = divs[1] / 6 ; //Odd for Height 25% of displayHeight
    divs[6] = divs[4] * 0.5 ; //Even for Width | x(width) of the inner screen (48%)
