class MusicPlayer {
  ...
  void divsArray() {
    ...
    //Note: Width=1920 pixels / Height=1080 pixels
    ...
    divs[2] = appWidth* 1 / 4; //Even for Width | x(width) of the inner screen
    divs[3] = appHeight* 1 / 2 ; //Odd for Height | y(height) of inner screen
    
    /*
    divs[0] = appWidth * 16 / 64 ; //Even for Width 25% of displayWidth
    divs[1] = appHeight * 16 / 64 ; //Odd for Height 25% of displayHeight
    divs[2] = appWidth * 16 / 33 ; //Even for Width | x(width) of the inner screen (48%)
    divs[3] = appHeight * 16 / 44 ; //Odd for Height | y(height) of inner screen (36.5%)
    */
    /*
    divs[4] = ;
     divs[5] = ;
